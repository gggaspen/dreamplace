...
export function DashboardHeader({ actions, ...props }: Omit<PageHeaderProps, 'title'> & { actions?: ReactNode }) {
  return (
    <PageHeader
      title="Dashboard"
...
export function AdminHeader({ actions, ...props }: Omit<PageHeaderProps, 'title'> & { actions?: ReactNode }) {
  return (
    <PageHeader
      title="Admin Panel"
...
export function ArtistHeader({ actions, ...props }: Omit<PageHeaderProps, 'title'> & { actions?: ReactNode }) {
  return (
    <PageHeader
