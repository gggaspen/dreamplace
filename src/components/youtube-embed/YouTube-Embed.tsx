...
import { FooterSection } from '@/interfaces/api-responses.interface';
...
const YouTubeEmbed = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const _footerSection: FooterSection = await getFooterSection();
  ...
  return (
    <Flex justifyContent={'center'} alignItems={'center'} py={{ base: '2em', lg: '4em' }}>
      {embedSrc && (
        <iframe
          width='100%'
          height='315'
