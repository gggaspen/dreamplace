...
export const LazyCarousel = lazyLoad(() => import('@/app/pages/carousel/Carousel'));

export const LazyPressCarousel = lazyLoad(() => import('@/app/pages/press/carousel/PressCarousel'));

export const LazyContact = lazyLoad(() => import('@/app/pages/contact/Contact'));

export const LazyFooter = lazyLoad(() => import('@/app/pages/footer/Footer'));
