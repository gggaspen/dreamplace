...
export function useComponentFactory() {
  ...
  const createComponents = useCallback(async (
  ...
  const createWithFallback = useCallback(async (
    config: ComponentConfig,
  ...
  const createButton = useCallback(async (props: Record<string, unknown>) => {
  ...
  const createCard = useCallback(async (props: Record<string, unknown>) => {
    const config: ComponentConfig = {
      type: 'card',
      props,
    };
  ...
  const createGrid = useCallback(async (props: Record<string, unknown>) => {
    const config: ComponentConfig = {
      type: 'grid',
      props,
    };
  ...
  const createInput = useCallback(async (props: Record<string, unknown>) => {
    const config: ComponentConfig = {
      type: 'input',
      props,
    };
