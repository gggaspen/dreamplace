            ...
            <Card>
              <CardBody>
                <VStack align="start" spacing={2}>
                  <HStack>
                    <Text fontSize="sm" color="gray.600">User Management</Text>
            ...
            <Card>
              <CardBody>
                <VStack align="start" spacing={2}>
                  ...
                  <Text fontSize="sm" color="gray.500">Live Events</Text>
                </VStack>
              </CardBody>
            </Card>
          </GridItem>
          ...
          <GridItem>
            <Card>
              <CardBody>
                <VStack align="start" spacing={2}>
                  <HStack>
                    <Text fontSize="sm" color="gray.600">Artists</Text>
                    <Badge colorScheme="purple">Active</Badge>
                  </HStack>
                  <Text fontSize="2xl" fontWeight="bold">156</Text>
                  <Text fontSize="sm" color="gray.500">Registered Artists</Text>
                </VStack>
              </CardBody>
            </Card>
          </GridItem>
              ...
              <Grid templateColumns="repeat(auto-fit, minmax(200px, 1fr))" gap={4}>
                <Button colorScheme="blue" size="lg" h="auto" p={4}>
                  <VStack spacing={2}>
                    ...
                    <Text fontSize="sm" opacity={0.8}>Manage user accounts and permissions</Text>
                  </VStack>
                </Button>
                ...
                <Button colorScheme="green" size="lg" h="auto" p={4}>
                  <VStack spacing={2}>
                    ...
                    <Text fontSize="sm" opacity={0.8}>Create and manage events</Text>
                  </VStack>
                </Button>
                ...
                <Button colorScheme="purple" size="lg" h="auto" p={4}>
                  <VStack spacing={2}>
                    ...
                    <Text fontSize="sm" opacity={0.8}>Manage artist profiles</Text>
                  </VStack>
                </Button>
                ...
                <Button colorScheme="orange" size="lg" h="auto" p={4}>
                  <VStack spacing={2}>
                    ...
                    <Text fontSize="sm" opacity={0.8}>Manage site content</Text>
                  </VStack>
                </Button>
                ...
                <Button colorScheme="red" variant="outline" size="lg" h="auto" p={4}>
                  <VStack spacing={2}>
                    ...
                    <Text fontSize="sm" opacity={0.8}>Configure system parameters</Text>
                  </VStack>
                </Button>
                ...
                <Button colorScheme="gray" size="lg" h="auto" p={4}>
                  <VStack spacing={2}>
                    ...
                    <Text fontSize="sm" opacity={0.8}>View platform analytics</Text>
                  </VStack>
                </Button>
              </Grid>
            </VStack>
        ...
        <Card>
          <CardBody>
            <VStack align="start" spacing={4}>
              ...
              <VStack align="start" spacing={2}>
                <Text><strong>Admin:</strong> {user?.profile.displayName}</Text>
                <Text><strong>Email:</strong> {user?.email}</Text>
                <Text><strong>Roles:</strong> {user?.profile.roles.join(', ')}</Text>
                <Text><strong>Session Started:</strong> {new Date().toLocaleString()}</Text>
              </VStack>
            </VStack>
          </CardBody>
        </Card>
